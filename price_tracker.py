...
Info  : https://brightdata.jp/products/insights/price-tracker/tmall
"""
...
# https://brightdata.jp/products/web-scraper/tmall
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Tmall scraper at: https://brightdata.jp/products/web-scraper/tmall\n"
